...
const LoanComponent = () => {
    ...
    const fetchLoanRequests = async () => {
        try {
            const response = await fetch(`http://localhost:8599/v1/hris/loan/loan-requests-by-id?id=${id}`);
    ...
    const handleApprove = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:8599/v1/hris/loan/approveLoanRequest`, {
    ...
    const handleReject = async () => {
        ...
        try {
            const response = await fetch(`http://localhost:8599/v1/hris/loan/rejectLoanRequest`, {
