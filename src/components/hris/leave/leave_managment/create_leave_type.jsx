...
const Create_Leave_Type = () => {
    ...
    const fetchEmployeeTypes = async () => {
        try {
            const response = await fetch(
                `http://localhost:8590/v1/hris/leave/get-leave-name`
            );
    ...
    const handleSaveEmployeeType = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:8590/v1/hris/leave/add-leave-categoryName`,
                {
                    method: "POST",
                    headers: {
    ...
    const handleUpdateEmployeeType = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:8590/v1/hris/leave/update-leave-category-name?id=${editType.id}`, // Pass ID as a query parameter
                {
                    method: "PUT",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const handleDeleteEmployeeType = async () => {
        ...
        try {
            const response = await fetch(
                `http://localhost:8590/v1/hris/leave/delete-leave-category-name?id=${typeToDelete.id}`, // Pass ID as query parameter
                {
                    method: "DELETE",
                }
            );
