...
const Upcoming_Birthdays = () => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-2xl p-6 w-[500px]">
            ...
            <p className="text-sm text-gray-500 mb-6">Birthdays Happening Soon</p>
            ...
            <div className="mt-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <span className="bg-blue-100 text-blue-600 text-xs font-medium py-1 px-2 rounded-lg">
                        Upcoming Birthdays
                    </span>
...
export default Upcoming_Birthdays;
