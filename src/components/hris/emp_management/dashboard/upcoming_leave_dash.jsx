...
const PendingLeaveRequests = () => {
    ...
    return (
        <div className="bg-white shadow-lg rounded-2xl p-6 w-[500px]">
            <h3 className="text-lg font-bold mb-4">Pending Leave Request</h3>
            <p className="text-sm text-gray-500 mb-6">Last Leave Request Overview</p>
            ...
            <div className="mt-6 flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                    <span className="bg-purple-100 text-purple-600 text-xs font-medium py-1 px-2 rounded-lg">
                        Pending leaves
                    </span>
