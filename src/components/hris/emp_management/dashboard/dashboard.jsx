...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchAttendanceHistory = async () => {
      try {
        const response = await fetch(`http://localhost:8590/v1/hris/employees/getAttendanceStatsForLastFiveDays`);
  ...
  useEffect(() => {
    const fetchBirthdays = async () => {
      try {
        const response = await fetch(`http://localhost:8590/v1/hris/employees/get-birthdays`);
        const result = await response.json();
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await fetch(`http://localhost:8590/v1/hris/employees/getAttendanceStats`);
        const result = await response.json();
