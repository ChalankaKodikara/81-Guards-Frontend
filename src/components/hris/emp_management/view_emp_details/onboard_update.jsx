...
import Personal_Doc from "./personal_doc_edit";
import Personal_Details from "./personal_details_Update";
import NextOfKings from "./next_of_kings_edit";
import Employment_Details from "./employment_details_edit";
import Bank_Details from "./bank_details_Edit";
...
const OnboardUpdate = () => {
  ...
  const handleFileUploadBankDetails = async (employee_no) => {
  ...
  const handleFileUpload = async (employee_no) => {
    const formData = new FormData();
